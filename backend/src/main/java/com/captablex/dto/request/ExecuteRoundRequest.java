...
@AllArgsConstructor
@Builder
@Schema(description = "Payload to atomically execute and commit a venture funding round into the cap table")
public class ExecuteRoundRequest {

    @NotNull(message = "Company ID is required")
    @Schema(description = "UUID of target company", example = "a1b2c3d4-0001-4000-8000-000000000001")
    private UUID companyId;

    @Schema(description = "Formal financing round title", example = "Series A Preferred")
    @Builder.Default
    private String roundName = "Series A Preferred";
    ...
    @Schema(description = "Name of the new incoming investor", example = "Alpha Ventures")
